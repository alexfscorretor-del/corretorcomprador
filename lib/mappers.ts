...
export function mapRowToProperty(row: DbPropertyRow): Property {
  return {
    ...
    aceitaFinanciamento: (row.aceita_financiamento as Property['aceitaFinanciamento']) ?? '',
    ...
    anotacaoPrivada: row.anotacao_privada ?? '',
  };
}
...
export function propertyToDbPayload(
  ...
  return {
    ...
    anotacao_privada: prop.anotacaoPrivada || null,
    fotos,
    archived: false,
  };
}
